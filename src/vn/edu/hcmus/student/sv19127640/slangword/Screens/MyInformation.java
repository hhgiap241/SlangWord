...
public class MyInformation {
    ...
    public MyInformation(){
        ...
        project.setFont(project.getFont().deriveFont (26.0f));
        ...
        JLabel project_1 = new JLabel("Slang Word");
        project_1.setFont(project_1.getFont().deriveFont (26.0f));
